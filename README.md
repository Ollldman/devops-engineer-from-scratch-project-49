...
[![hexlet-check](https://github.com/Ollldman/devops-engineer-from-scratch-project-49/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/Ollldman/devops-engineer-from-scratch-project-49/actions)
...
```bash
git clone https://github.com/Ollldman/devops-engineer-from-scratch-project-49.git
